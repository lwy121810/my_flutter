...
class DJTabIndicator extends Decoration {
  final Color? color;
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _DJBoxDecorationPainter(this, onChanged);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is DJTabIndicator &&
        other.color == color &&
...
class _DJBoxDecorationPainter extends BoxPainter {
  _DJBoxDecorationPainter(this._decoration, VoidCallback? onChanged) : super(onChanged);

  final DJTabIndicator _decoration;
